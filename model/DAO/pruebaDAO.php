...
class pruebaDAO {
    ...
    public function guardar($ces) {
        ...
        if ($conexion != null) {
            ...
            $consulta->bindParam(':fec', $ces->getFecha());
            $consulta->bindParam(':por', $ces->getPorcentaje());
            $consulta->bindParam(':idpr', $ces->getId_prueba());
            $consulta->bindParam(':idu', $ces->getId_unidad());
            $consulta->bindParam(':idt', $ces->getId_tema());
